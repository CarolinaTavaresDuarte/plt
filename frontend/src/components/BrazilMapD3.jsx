...
      const g = svg.append("g");
      ...
      // *** 5. NOVO: Adiciona mouseout ao SVG para cobrir a área total ***
      // Se o mouse sair do SVG, remove o tooltip, cobrindo o país e a área em branco.
...
          })
          .on("mouseout", removeTooltip); // Mantém, mas o do SVG será o principal
...
      <h3 style={{ textAlign: 'center', marginBottom: '15px' }}>Percentual de TEA na População Indígena por Localização (IBGE - 2022)</h3>
